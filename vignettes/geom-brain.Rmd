...
This has introduced alot of new functionality into the package, in addition to some new custom methods and objects. 
...
## Plotting with data
Of course, as usual, people will have their own data they want to add to the plots, usingcolumns from their own data to the plot aesthetics. 
...
Just like in ggseg, though, you still need to do some double work for facetting to work correctly.
